...
- General Data-centric Machine Learning: 
  ...
  I prioritize optimizing data quality (e.g., addressing issues like  <font color=orange>imbalance</font>, <font color=orange>noise</font>, and <font color=orange>out-of-distribution</font>), quantity (e.g., through improved <font color=orange>annotation</font> and <font color=orange>augmentation</font>), efficiency (e.g., using techniques like <font color=orange>distillation</font>, <font color=orange>compression</font>, and <font color=orange>selection</font>), and <font color=orange>privacy</font> (e.g., addressing potential attacks). 
...
- Graph Learning in Complex Scenarios: 
  ...
  My research in developing **effective graph models in various high-order relation data modeling while maintaining scalability in industry-level scenarios**.
